...
| Memento review / sharing / history | Partial | The unreleased web-v72 candidate uses one shutter for sequential views, a compact review with Retake / Send to the named chat, collapsed extras, and visible send feedback. Confirmed deployed secondary-upload/CSP defect requires an additive API patch; see MEMENTO_SEND_FIX_2026-09-07.md. Date boundaries and real-account/device confirmation remain. |
