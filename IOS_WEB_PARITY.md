...
| Profile | Photo, bio, information cooldown, stats/streak, weekly/all-time top polls, Ask link controls, install, support/privacy, deletion/recovery | Profile and account-lifecycle journeys |
...
- StoreKit God Mode, reveals, boosts, and purchases are not copied to Stripe in
  this release candidate. Web recurring billing needs a separate pricing,
  entitlement, tax, refund, and App Review decision; it must not be improvised
  inside the core-flow launch.
